...
<br />
<div align="center">
  <h1 align="center">Travel Sense Flutter app backend REST API</h1>
  <br />
  <p align="center">
    This is the REST API for Travel Sense Flutter app.
    <br />
  </p>
</div>
...
2. Clone the repo
   ```sh
   git clone https://github.com/KanishaLiyanage/travel-sense-flutter-app-backend-expressjs.git
   ```
...
Project Link: [https://github.com/KanishaLiyanage/travel-sense-flutter-app-backend-expressjs.git](https://github.com/KanishaLiyanage/travel-sense-flutter-app-backend-expressjs.git)
